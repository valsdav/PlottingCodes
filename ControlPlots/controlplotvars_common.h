...
//    plotvar	MINRange  MAXRange  NBINS  slog xlabel outfile AMINRange  AMAXRange ANBINS drawleg
  ...
  { "v_pt",		200, 800, 15, 3,	"W p_{T} (GeV)", 		"v_pt", 200, 800, 15, 1 },
//  { "v_mt",		0, 140, 14, 3,		"W Transverse Mass (GeV)",	"v_mt", 0,  140, 14, 1 },
//
//  { "pfMET",		0, 500, 20, 3,		"pf MET (GeV)",  "pfmet",                0,  500, 20, 1 },
//  { "pfMETpuppi",	0, 500, 20, 3,		"pf MET (puppi) (GeV)",  "pfmetpuppi",   0,  500, 20, 1 },
//  { "pfMET_Phi",	-5, 5, 20, 3,		"pf MET #phi ", "pfMET_Phi",	      -5, 5, 20, 0},
//
//  { "l_pt",		20, 320, 10, 3,		"Lepton p_{T} (GeV)",     "lepton_pt",       20,  320, 10, 1 },
//  { "l_eta",		-2.4, 2.4, 8, 1,	"Lepton #eta",            "lepton_eta",    -2.4,  2.4,  8, 0 },
//
...
////  { "PuppiAK8_jet_mass_fi", 	0, 160, 10, 1, "AK8 fi mass (GeV)", "Puppi_AK8_mass_fi", 0, 160,10, 1},
//  { "ungroomed_PuppiAK8_jet_pt",200, 800, 15, 1, "AK8 Puppi p_{T} GeV", "ungroomed_PuppiAK8_jet_pt", 200, 800, 15, 1},
//  { "deltaphi_METak8jet", 0, 3.2, 8, 1, "#Delta #phi (Leading Jet, MET)", "deltaphi_metak8jet", 0, 3.2, 8, 0 },
//
//  { "PuppiAK8_jet_tau2tau1", 	0, 1, 10, 1, "AK8 #tau_{2}/#tau_{1}", "PuppiAK8_jet_tau2tau1", 0,1,10,1},
//
...
//  { "TempWWRapidity", 	-2.5, 2.5, 10, 1, 	"WW Rapidity"  , "TempWWRapidity" , -2.5, 2.5, 10, 1}, 
...
//  { "costhetastar_type2", 	-1,1, 10, 1, 	"costhetastar_type2"  , "costhetastar_type2" ,-1,1, 10, 0}, 
//  { "costhetastar_type0", 	-1,1, 10, 1, 	"costhetastar_type0"  , "costhetastar_type0" ,-1,1, 10, 0}, 
...
//  { "phi1_run2", 	-5,5, 10, 1, 	"phi1_run2"  , "phi1_run2" , -5, 5, 10, 0}, 
//  { "phi1_type2", 	-5, 5, 10, 1,	"phi1_type2"  , "phi1_type2" , -5, 5, 10, 0}, 
//  { "phi1_type0", 	-5, 5, 10, 1, 	"phi1_type0"  , "phi1_type0" , -5, 5, 10, 0}, 
//
