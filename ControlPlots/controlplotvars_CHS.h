...
//
//    LEPTONS
 { "l_pt1+pfMET+ungroomed_AK8jet_pt+vbf_maxpt_j1_pt+vbf_maxpt_j2_pt",	500, 4000, 20, 3, "HT", "ht", 500, 4000, 20, 1},
...
//
////////	MET
// { "pfMET",		0, 880, 16, 3,	"pf MET (GeV)",  		"pfmet",	 0, 880, 16, 1 },
// { "pfMET_Corr",	0, 900, 30, 3,	"pf MET Corr (GeV)",		"pfMET_Corr",	 0, 900, 30, 1 },
...
// { "AK8jet_mass", 	30, 330, 15, 1, "AK8 mass (GeV)",		"AK8_mass",    30, 330, 15, 1},
// { "AK8jet_mass_pr", 	30, 330, 15, 1, "AK8 pruned mass (GeV)",	"AK8_mass_pr", 30, 330, 15, 1},
// { "AK8jet_mass_so", 	30, 330, 15, 1, "AK8 Softdrop mass (GeV)",	"AK8_mass_so", 30, 330, 15, 1},
// { "AK8jet_mass_tr", 	30, 330, 15, 1, "AK8 tr mass (GeV)", 		"AK8_mass_tr", 30, 330, 15, 1},
//  
// { "mass_lvj_type0", 	0, 3000, 15, 1, "WW invariant mass (GeV)",		"mass_lvj_type0",    0, 3000, 15, 1},
// { "mass_lvj_type2", 	0, 3000, 15, 1, "WW invariant mass (GeV)",		"mass_lvj_type2",    0, 3000, 15, 1},
// { "mass_lvj_run2", 	0, 3000, 15, 1, "WW invariant mass (GeV)",		"mass_lvj_run2",    0, 3000, 15, 1},
//
////	Number of jets
