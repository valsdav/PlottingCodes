void RunMacro()
{
  ...
  //gROOT->ProcessLine(".L model.C+");
    ...
    // Older Ntuples 11 October
    /*
    gROOT->ProcessLine("myControlPlots(\"DibosonBoostedMuCuts13TeV_WjetControlRegion_Tighter_CHS.txt\", \"DibosonBoostedMuSamples13TeV_InData_11Oct_OnlyCHS.txt\", commonplotvars_chs ) ");
    ...
    gROOT->ProcessLine("myControlPlots(\"DibosonBoostedMuCuts13TeV_QCDControlRegion_Tighter_CHS.txt\", \"DibosonBoostedMuSamples13TeV_InData_11Oct_OnlyCHS.txt\", commonplotvars_chs ) ");
    ...
    gROOT->ProcessLine("myControlPlots(\"DibosonBoostedElCuts13TeV_QCDControlRegion_Tighter_CHS.txt\", \"DibosonBoostedElSamples13TeV_InData_11Oct_OnlyCHS.txt\", commonplotvars_chs ) ");
    */
    gROOT->ProcessLine("myControlPlots(\"DibosonBoostedMuCuts13TeV_WjetControlRegion_Tighter_CHS.txt\", \"DibosonBoostedMuSamples13TeV_2017-11-07_14h59_OnlyCHS.txt\", commonplotvars_chs ) ");
    //gROOT->ProcessLine("myControlPlots(\"DibosonBoostedElCuts13TeV_WjetControlRegion_Tighter_CHS.txt\", \"DibosonBoostedElSamples13TeV_2017-11-07_14h59_OnlyCHS.txt\", commonplotvars_chs ) ");
