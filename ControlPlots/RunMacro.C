void RunMacro()
{
  ...
  //gROOT->ProcessLine(".L model.C+");
    ...
    //gROOT->ProcessLine("myControlPlots(\"DibosonBoosted_mu_sig.txt\", \"DibosonBoostedMuSamples13TeV.txt\")");
    //gROOT->ProcessLine("myControlPlots(\"DibosonBoosted_2mu_sig.txt\", \"DibosonBoostedMuSamples13TeV.txt\")");
    gROOT->ProcessLine("myControlPlots(\"DibosonBoostedMuCuts13TeV_WjetControlRegion.txt\", \"DibosonBoostedMuSamples13TeV.txt\")");
    //gROOT->ProcessLine("model(\"DibosonBoosted_2mu_sig.txt\", \"DibosonBoostedMuSamples13TeV_model.txt\")");
